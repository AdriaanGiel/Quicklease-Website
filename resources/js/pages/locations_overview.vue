<template>
    <section class="animated fadeIn">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <location-button @click="$router.push({ name: 'single-location', params: { id: location.id } })" class="location-overview-grid location-button-padding" :location="location" v-for="location in locations" :key="location.id"></location-button>
                </div>
            </div>
        </div>
    </section>
